...
public class JsonLongDoubleFloatDoubleVertexInputFormat 
extends TextVertexInputFormat<LongWritable, DoubleWritable, FloatWritable> {
	...
	extends TextVertexReaderFromEachLineProcessedHandlingExceptions
	<JSONArray, JSONException> {

		@Override
		protected JSONArray preprocessLine(Text line) 
		...
		@Override
		protected Iterable<Edge<LongWritable, FloatWritable>> 
		...
		@Override
		protected Vertex<LongWritable, DoubleWritable, FloatWritable, DoubleWritable>
